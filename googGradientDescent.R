...
inputIndicator = (Quandl.search(query = "Google" , silent = TRUE))[[1]]$code
# The quantmod package is ready for use:
library(Quandl)
library(quantmod)
# Load the Facebook data with the help of Quandl
Google = Quandl(inputIndicator,type="xts")
...
# optimized to google : learning rate and iteration limit
alpha <- 0.0000001
num_iters <- 300
